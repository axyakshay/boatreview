...
class BoatsControllerTest < ActionController::TestCase
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post :create, boat: { boat_dimensions: @boat.boat_dimensions, description: @boat.description, place: @boat.place, rating: @boat.rating, title: @boat.title }
    end
  ...
  test "should update boat" do
    patch :update, id: @boat, boat: { boat_dimensions: @boat.boat_dimensions, description: @boat.description, place: @boat.place, rating: @boat.rating, title: @boat.title }
    assert_redirected_to boat_path(assigns(:boat))
  end
